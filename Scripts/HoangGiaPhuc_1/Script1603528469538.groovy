...
WebUI.verifyElementText(findTestObject('Page_UP Portal  HoChiMinh University of Pedagogy/td_THANH CNG C'), 'THANH CÔNG CỤ')

WebUI.waitForElementPresent(findTestObject('Page_UP Portal  HoChiMinh University of Pedagogy/td_THANH CNG C'), 30)
